...
function TextAndIcons({ selectedDetails }: { selectedDetails: WorkExperience }) {
    ...
    return (
        <div className="w-full xl:w-1/2 text-xl xl:text-2xl flex flex-col h-auto xl:h-full justify-start gap-10" style={{ maxWidth: 1000 }}>
            <m.aside
                {...animation}
                transition={{ easings: "cubic-bezier(0.83, 0, 0.17, 1)", delay: screenTransitionDuration }}
                className="flex-1 flex justify-center items-start flex-col gap-3"
